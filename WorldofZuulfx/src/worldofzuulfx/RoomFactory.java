...
public class RoomFactory {
    ...
    public static ArrayList<Room> createRooms(HashMap<Integer, Tile> tiles, Pane backgroundLayer, Pane objectLayer) {
        ...
        hutten = new Room("hutten", "hutten", backgroundLayer, objectLayer, tiles, new int[][]{{0, 12, 12, 12, 214, 12, 12, 12, 12, 214, 12, 0},
        ...
        canteen = new Room("Canteen", "Canteen", backgroundLayer, objectLayer, tiles, new int[][]{{0, 12, 12, 12, 12, 214, 12, 12, 12, 12, 12, 0},
        ...
        knoldene = new Room("knoldene", "knoldene", backgroundLayer, objectLayer, tiles, new int[][]{{0, 12, 12, 12, 12, 214, 12, 12, 12, 12, 12, 0},
                                                                                                    {0, 12, 13, 13, 13, 215, 13, 13, 13, 13, 12, 0},
                                                                                                    {0, 12, 6, 20, 20, 20, 20, 20, 20, 20, 12, 0},
                                                                                                    {0, 12, 6, 20, 20, 20, 20, 20, 20, 20, 12, 0},
                                                                                                    {0, 12, 6, 20, 20, 20, 20, 20, 20, 20, 12, 0},
        ...
        u163 = new Room("u163", "u163", backgroundLayer, objectLayer, tiles, new int[][]{{0, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 0},
                                                                                         ...
                                                                                         {0, 12, 6, 20, 20, 20, 20, 20, 20, 20, 12, 0},
                                                                                         {0, 12, 6, 20, 20, 20, 20, 20, 20, 20, 12, 0},
                                                                                         {0, 12, 20, 20, 20, 20, 20, 20, 20, 20, 12, 0},
                                                                                         {0, 12, 6, 20, 20, 20, 20, 20, 20, 20, 12, 0},
                                                                                         {0, 12, 6, 20, 20, 20, 20, 20, 20, 20, 12, 0},
                                                                                         {0, 12, 6, 20, 20, 20, 20, 20, 20, 20, 12, 0},
                                                                                         {0, 12, 12, 12, 12, 20, 12, 12, 12, 12, 12, 0},
        ...
        outside.setExit("0600", campus, campus.getTileMap().getTile("0610"));
